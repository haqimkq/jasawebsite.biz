@props(['id' => null, 'domain' => '[]', 'label' => '[]', 'name' => ''])

<div id="addLabelDomainModal2-{{ $id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800 border-white border">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="addLabelDomainModal2-{{ $id }}">
            ...
            <div class="my-10 flex justify-center sm:p-0 p-3">
                <div class=" max-w-xl sm:min-w-[576px] w-full">
                    <form class="w-full" method="POST" action="{{ route('labels.labelDomain', $id) }}">
                        @csrf
                        <select name="domains[]" id="domainSelect-{{ $id }}" class="js-example-basic-multiple"
