<div id="addNotepad" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800 border-white border">
            ...
            <!-- Modal body -->
            <form action="{{ route('notepad.store') }}" method="POST">
                @csrf
                @method('POST')
                <div class="p-5">
                    <textarea name="notepad" class="bg-gray-700 w-full text-white" placeholder="Take a Note.." id="" cols="30"
                        rows="10"></textarea>
                    <div>
                        <button type="submit"
