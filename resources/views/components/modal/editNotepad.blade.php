<div id="editNotepad-{{ $notepad->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800 border-white border">
            ...
            <div class="flex items-start justify-between p-2 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="editNotepad-{{ $notepad->id }}">
            ...
            <!-- Modal body -->
            <div class="">
                <textarea name="notepad" class="bg-gray-700 w-full text-white min-h-[300px] textAreaNotepad"
                    data-id="{{ $notepad->id }}" placeholder="Take a Note..">{{ $notepad->notepad }}
                    </textarea>
            </div>
        </div>
    </div>
