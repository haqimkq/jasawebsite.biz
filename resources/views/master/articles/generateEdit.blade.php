            ...
            <div class="border border-white roudned-lg rounded-lg my-5">
                ...
                <div class="p-3 space-y-3">
                    <div class="space-y-3">
                        ...
                        <input class="w-full rounded-lg bg-gray-600 py-2 px-3" name="spun_title"
                            value="{{ $article->spun_title }}" required>
                    </div>
                    <div class="space-y-3">
                        <label for="">Deskripsi</label>
                        <textarea class="h-screen" name="spun_article" id="wiswig">{{ $article->spun_article }}</textarea>
                    </div>
                    <div>
