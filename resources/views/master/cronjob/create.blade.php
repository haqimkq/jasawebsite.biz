<x-app-layout>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl overflow-x-hidden lg:py-8">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Add Routine Todo</h2>
            <div class="">
                <form action="{{ route('cronjob.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="space-y-4">
                        <div>
