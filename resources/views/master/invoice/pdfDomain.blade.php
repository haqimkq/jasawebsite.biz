        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="white-space: nowrap;">
                    ...
                    <p style="margin: 5px">{{ htmlspecialchars($nama_domain) }} </p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            <thead>
                <tr style="background-color: #2aa383; color: white; text-align: center; text-transform: capitalize;">
                    <th style="font-weight: normal; border: 1px solid #ccc; padding: 5px;">item</th>
                    <th style="font-weight: normal; border: 1px solid #ccc; padding: 5px;">Periode</th>
                    <th style="font-weight: normal; border: 1px solid #ccc; padding: 5px;">Quantity</th>
                    <th style="font-weight: normal; border: 1px solid #ccc; padding: 5px;">Rate</th>
                    <th style="font-weight: normal; border: 1px solid #ccc; padding: 5px;">Total</th>
                </tr>
            </thead>
            <tbody style="background-color: #f4f4f4;">
                ...
                @foreach ($item as $items)
                    @php
                        $formattedPeriodeAkhir = $items['periode_akhir'] ? date('d M Y', strtotime($items['periode_akhir'])) : '';
                        
                        $formattedPeriodeAwal = $items['periode_awal'] ? date('d M Y', strtotime($items['periode_awal'])) : '';
                        
                    @endphp
                    <tr style="text-align: center;">
                        <td style="border: 1px solid #ccc; padding: 5px 10px 5px 10px;text-align: left;">
                            <p>{{ htmlspecialchars($items['name']) }}</p>
                        </td>
                        <td style="border: 1px solid #ccc; padding: 5px 10px 5px 10px;">
                            {{ htmlspecialchars($formattedPeriodeAwal) }} -
                            {{ htmlspecialchars($formattedPeriodeAkhir) }}
                        </td>
                        <td style="border: 1px solid #ccc; padding: 5px 10px 5px 10px;">
                            {{ htmlspecialchars($items['qty']) }}
                        </td>
                        <td style="border: 1px solid #ccc; padding: 5px 10px 5px 10px;text-align: left">Rp.
                ...
                <tr style="text-align: right;">
                    <td colspan="4" style="background-color: white; border: none; padding: 5px 10px 5px 10px;">
                        Total</td>
                    <td style="border: 1px solid #ccc; padding: 5px 10px 5px 10px;text-align: left">Rp.
                ...
                <tr style="text-align: right;">
                    <td colspan="4" style="background-color: white; border: none; padding: 5px 10px 5px 10px;">
                        Balance Due</td>
                    <td
                        style="background-color: #2aa383; color: white; border: 1px solid #ccc; padding: 5px 10px 5px 10px;text-align: left">
                        Rp.
