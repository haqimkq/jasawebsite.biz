    <x-app-layout title="Buat Invoice Pelanggan">

        <section class="bg-white dark:bg-gray-900">

            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                <h2 class="mb-4 text-lg sm:text-xl font-bold text-gray-900 dark:text-white">Buat Invoice</h2>
                <form action="{{ route('invoicePelangganStore') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="grid gap-2 grid-cols-2 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="col-span-2 sm:col-span-1 hidden">
                            <label for="nama_domain"
                                class="block mb-2 text-xs sm:text-sm font-medium text-gray-900 dark:text-white">Pelanggan
                                ID</label>
                            <input type="text" name="id_pelanggan" id="nama_domain"
                                class=" bg-gray-200 border border-gray-300 text-gray-900 text-xs sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                value="{{ $pelanggan->id }}">
                        </div>
                        <table class="table table-bordered col-span-2" id="dynamicTable">
                            <tr>
                                <th class=" mb-2 text-xs sm:text-sm font-medium text-gray-900 dark:text-white">Item</th>
                                <th class=" mb-2 text-xs sm:text-sm font-medium text-gray-900 dark:text-white">Quantity
                                </th>
                                <th class=" mb-2 text-xs sm:text-sm font-medium text-gray-900 dark:text-white">Price
                                </th>
                                <th class=" mb-2 text-xs sm:text-sm font-medium text-gray-900 dark:text-white"></th>
                            </tr>
                            <tr>
                                <td class="p-1">
