<x-app-layout>
    ...
    <div>
        <div class="p-5">
            <form action="{{ route('labelDomain.update', $labelDomain->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="">
                    ...
                    <div class="flex gap-4">
                        <div class="flex-auto">
                            <input type="text" name="name" id="nama_pelanggan"
                                ...
                                placeholder="Masukan Nama Label" required="" value="{{ $labelDomain->name }}">
                        </div>
                        <div class="col-span-1 border rounded-lg flex justify-center px-3 items-center relative">
                            ...
                            <input type="color" name="color" id="editColorInput"
                                class="opacity-0 z-50 absolute bg-gray-50 border" value="{{ $labelDomain->color }}"
                                required="">
                        </div>
