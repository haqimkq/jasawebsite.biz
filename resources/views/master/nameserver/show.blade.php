        ...
        <div class="pb-3 pt-2 px-4 mx-auto mt-5 rounded-xl max-w-2xl lg:pb-6 lg:pt-2 bg-gray-600">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="grid grid-cols-4 col-span-2 mt-4">
                    <label for="jumlah_email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                        Domain</label>
                ...
                <div class="grid grid-cols-4 col-span-2 ">
                    <label for="epp_code"
                        class="col-span-1 block mb-2 text-sm font-medium text-gray-900 dark:text-white">EPP Code</label>
                ...
                <div class="grid grid-cols-4 col-span-2">
                    <label for="kapasitas_hosting"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kapasitas hosting</label>
