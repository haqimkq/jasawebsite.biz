<x-app-layout title="Tambah Template">
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <form action="{{ route('daftartemplate.update', $daftartemplate->id) }}" method="post"
                ...
                <div class="flex justify-center">
                    <div class="relative">
                        <img id="fotoProfil" class="object-cover w-40 h-40"
                            src="{{ asset('storage/images/template/') }}/{{ $daftartemplate->image }}" alt="">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="nama_template" id=""
                            ...
                            value="{{ $daftartemplate->nama_template }}">
                    </div>
                    <div class="col-span-2">
                        ...
                        <input type="url" name="link" id=""
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Masukan URL Website" required="" value="{{ $daftartemplate->link }}">
                    </div>
                    <div class="col-span-2">
                        <label for=""
                        ...
                        <input type="number" name="harga" id=""
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Masukan Harga Website" required="" value="{{ $daftartemplate->harga }}">
                    </div>
                    <div>

                        <input type="checkbox" name="show_harga" value="1"
                            @if ($daftartemplate->show_harga == 1) checked @endif>
                    </div>
                </div>
                <button type="submit"
