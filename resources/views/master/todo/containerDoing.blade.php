<div class="space-y-3" id="containerDoingUpdate">
    @if ($domainsDoing->count() > 0)
        @foreach ($domainsDoing as $domain)
        ...
        $('.toDoButton').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#containerDoingUpdate').load('/todos/containerDoing');
                    $('#containerTodoUpdate').load('/todos/containerTodo');
